      ...
      <View style={styles.contentSection}>
        ...
        <View style={styles.ratingsContainer}>
          <View style={styles.ratingBox}>
            ...
            <PokeBallRating score={game.criticScore} type="critic" size="large" />
          </View>
          <View style={styles.ratingBox}>
        ...
        <View style={styles.reviewsContainer}>
          ...
          <Text style={[styles.sectionTitle, styles.userReviewsTitle]}>User Reviews</Text>
...
const mockGame = {
  id: '1',
  title: 'Pokémon Red',
  description: 'Pokémon Red is a 1996 role-playing video game developed by Game Freak and published by Nintendo for the Game Boy.',
  imageUrl: 'https://cdn.discordapp.com/attachments/750486359386357863/1219035852714545152/photo_2024-03-17_17-32-52.jpg?ex=67293d9b&is=6727ec1b&hm=3eeeceb76a7e05732fb917f1c2af01984c03f12ce891c7bf730304d409948301&',
  criticScore: 85,
  userScore: 90,
  ...
  criticReviews: [
    {
      ...
      score: 13,
      content: 'Con el corazon roto... pero con la esperanza de que el proximo sea mejor',
      date: '2005-03-01',
    },
    // ...more reviews
  ],
  userReviews: [
    {
      ...
      score: 95,
      content: 'Soy un tanke soy un tanke soy un tanke soy un tanke soy un tanke',
      date: '11-09-2024',
    },
    {
